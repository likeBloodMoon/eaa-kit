...
accordance with the Act on the Accessibility of Certain Products and Services (SFS
2023:254), which transposes Directive (EU) 2019/882 (the European Accessibility Act) into
Swedish law. Its requirements apply from 28 June 2025.
...
The automated test run of 21 August 2026 covered 8 pages of
this website.
...
The assessment relies in part on automated testing. Automated tools detect only a subset of
possible barriers; they are not a substitute for manual testing or for testing with
...
If you are not satisfied with our response, you can report the matter to the Swedish Post
and Telecom Authority (PTS), which supervises e-commerce services under the Act.

Post- och telestyrelsen (PTS)
https://pts.se

Websites and mobile applications of public sector bodies fall under a separate act, which
requires an accessibility statement of its own. This document is not that statement.
