...
Musterbetrieb GmbH is committed to making the website Musterbetrieb accessible in
accordance with the European Union (Accessibility Requirements of Products and Services)
Regulations 2023 (S.I. No. 636 of 2023), which transpose Directive (EU) 2019/882 (the
European Accessibility Act) into Irish law. They apply from 28 June 2025.

This accessibility statement applies to https://example.at.

## Compliance status

This website is partially compliant with EN 301 549 V3.2.1 (WCAG 2.2 AA). The content listed in
...
The automated test run of 21 August 2026 covered 8
pages of this website.
2 further rule checks require a manual decision.
12 rule checks could not be decided by the tool that was used; they
...
- Contact form: https://example.at/kontakt
- Phone: +43 1 2345678
...
If you are not satisfied with our response, you can complain to the Competition and
Consumer Protection Commission (CCPC), which enforces the accessibility requirements for
e-commerce services and e-books.

Competition and Consumer Protection Commission
https://www.ccpc.ie

Supervision is split by sector: electronic communications services are overseen by the
Commission for Communications Regulation (ComReg), and consumer banking services by the
Central Bank of Ireland.

Websites and mobile applications of public sector bodies fall under a separate regime,
which requires an accessibility statement of its own. This document is not that statement.
